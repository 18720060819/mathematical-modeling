...
\begin{cnabstract}%此处没有采用sbstract命名，是为了将来如果要加入英文摘要时扩展的方便
    本模板根据“2016~高教社杯全国大学生数学建模竞赛论文格式规范”中的相关规定制作。供参加
全国大学生数学建模竞赛的同学们使用。制作该模板的目的在于推进竞赛论文格式规范化，
推广~\LaTeX{}。

    本模板将整篇论文视作“文章”（article），而不是“书”（book）。实现时，以~cctart 为基类。
与~cctart.cls 的使用基本相同，具体请参考本文源文件。
...
也没有引入其他的宏包，请使用时根据需要自行添加。
    ...
    \begin{tabbing}
      ...
      {}\> readme.pdf \> 本文件\\
      {}\> readme.tex \> 本文件源文件\\
      {}\> example.tex \> 示例文件源文件（也可以参考~readme.tex）\\
      {}\> example.pdf \> 示例文件
    \end{tabbing}
    ...
    \begin{enumerate}
      ...
      \item 本模板目前尚未得到全国大学生数学建模竞赛组委会的认可，模板作者对
            使用该模板所引起的后果不负任何责任。
    \end{enumerate}
    }
\end{cnabstract}
...
\bibitem{1} 全国大学生数学建模竞赛组委会, 2016~高教社杯全国大学生数学建模竞赛论文格式规范, 2016
\bibitem{2} 全国大学生数学建模竞赛组委会, 2016~高教社杯全国大学生数学建模竞赛论文格式规范, 2016
\end{thebibliography}
